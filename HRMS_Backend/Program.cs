...
builder.Services.AddCors(options =>
{
    options.AddPolicy(corsPolicyName, policy =>
    {
        ...
        //.WithOrigins("https://qa-hr.cortracker360.com")
             .WithOrigins("https://preprod-hr.cortracker360.com", "http://localhost:4200", "http://localhost:58565", "http://localhost:59539", "http://localhost:8080", "https://qa-hr.cortracker360.com") // 👈 exact frontend URL
            .AllowAnyMethod()
            .AllowAnyHeader()
